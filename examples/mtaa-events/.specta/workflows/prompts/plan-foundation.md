...
Reason from the user's project brief and produce the content for two Foundation artifacts: Vision and Constitution. Do not design the architecture, roadmap, epics, implementation, or source code during this stage.
