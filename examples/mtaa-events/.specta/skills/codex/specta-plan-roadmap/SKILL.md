...
2. Read `.specta/planning/vision.md`, `.specta/planning/constitution.md`, and `.specta/planning/architecture.md`. These are the validated planning views produced from the Workspace Graph. If `.specta/planning/roadmap.md` already exists, stop and report it. If a prerequisite view is absent, stop and tell the user which earlier Specta planning Skill to run.
...
7. On success, verify `.specta/planning/roadmap.md`. Report that path and the completed `roadmap` stage.
