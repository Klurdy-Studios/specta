...
import { createWorkspaceInitializer as createCoreWorkspaceInitializer } from "@specta/core/workspace"
import { implementationWorkflowModule } from "@specta/implementation"
import { planningWorkflowModule } from "@specta/planner"

const createWorkspaceInitializer = () => createCoreWorkspaceInitializer({
  workflowModules: [planningWorkflowModule, implementationWorkflowModule],
})
