...
Create only the Foundation planning stage. Let the coding agent reason about the project; let Specta validate, assign IDs, render Markdown, and update the Workspace Graph.
